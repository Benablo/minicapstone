...
<body>
    <div class="container col-sm-4 offset-sm-4">
        ...
        <div class="card shadow mb-5 rounded border border-dark mt-5">
            <div class="card-body" style="background-color: #000000;" id="card-bodyy">
                ...
                <form action="{{ '/register' }}" method="POST">
                    ...
                    <div class="d-flex mt-4">
                        <div class="flex-grow-1">
                            <a href="{{ '/' }}" class="text-danger">Already have an account?</a>
                        </div>
                        <div class="form-group text-center mt-4 mr-4">
                            <button class="btn btn-outline-primary" id="actionBtn" type="submit">Submit</button>
                        </div>
                    </div>
                    </form>
            </div>
