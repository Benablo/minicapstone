...
<body bg-info>
    <div class="container col-md-4 offset-md-4">
        ...
        <div class="card shadow mb-5 rounded border border-dark mt-5">
            <div class="card-body rounded" style="background-color: #000000; width:500px; margin: auto;" id="card-body">
                <h2 class="text-center mb-4" style="color:#b8c8cb; font-size: 25px;">Log In</h2>
                <form action="{{ '/' }}" method="POST">
                    ...
                    <div class="d-flex">
                        <div class="flex-grow-1">
                            <a href="{{ '/register' }}" class="text-danger">Sign up for an account?</a>
                        </div>
                        <div class="form-group text-center mt-4 mr-4">
                            <button class="btn btn-outline-primary" id="actionBtn" type="submit"> Login</button>
                        </div>
                    </div>
                    </form>
            </div>
