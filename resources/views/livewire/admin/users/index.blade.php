<div>
    <div class="text-center">
        <h1 style="font-size: 25px; font-weight: 400; color:">Users</h1>
        @include('livewire.modals.admin-modal')
        @if (session('message'))
            <div class="alert alert-success text-black text-center" id="messagee">{{ session('message') }}</div>
        @endif
        <input type="search" class="form-control float-start text-center mx-2 mb-3" style="" placeholder="Search" wire:model.lazy="search">
        <div class="card-body">
