...
<div>
    ...
    <div class="container mt-3">
        <h1 class="text-center asdf" style="font-size: 25px; font-weight: 500;">Permissions</h1>
        @include('livewire.modals.admin-modal')
        @if (session('message'))
            <div class="alert alert-success text-black text-center" id="messagee">{{ session('message') }}</div>
        @endif
        <div class='btn btn-primary btn-sm float-end mb-2'  style="background-color: #000000; color:white;" data-toggle="modal" data-target="#modal-permissions">Create New Permission</div>
        ...
        <div class="card-body">
            <table class="table shadow text-center table-hover table-dark table-striped">
                ...
                <tbody  class="">
                    ...
                    @if($permissions->count() == 0)
                        <td colspan="2" class="text-center" style="color: rgb(0, 0, 0)">
