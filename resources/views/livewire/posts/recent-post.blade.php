<div class="container col-md-12 ">
    ...
    <div class="post-body" style="margin: auto">
        ...
        <div class="col-md-4 bg-white" style="margin:auto; width: 700px">
            @if (session('message'))
                <div id="messagee" class="alert text-black text-center text-black">{{ session('message') }}</div>
            @endif
            <select class="form-select mb-1  bg-dark text-white maki" wire:model.lazy="title">
                <option class="bg-dark" value="All">All</option>
            ...
            <div class="col p-3 shadow-sm  mb-5" id="write">
            ...
            <div class="card mt-3 qweqweqwe {{ $recent->user->gender === 'Female' ? 'f1' : 'm1' }}" style=" margin: auto;">
    ...
    @if($recents->isEmpty())
        <div style="color:  rgb(241, 18, 18)">
            <h1 class="text-center" style="font-size: 30px;">No post</h1>
        </div>
    @endif
