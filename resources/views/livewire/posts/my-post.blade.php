<div class="div">
    ...
    <div class="container ">
        <div class="profile">
            <h2 class="mt-3 text-center" style="font-size: 23px; color:#000000;">Profile</h2>
        </div>
        <div class="post-body">
            <div class="col-md-6 " style="margin: auto; width: 700px">
                <div class=" shadow-md p-3 " id="write">
                    <button class="write-2 form-control" style="color:white;background-color: #1e2120;" data-toggle="modal" data-target="#click">Create new post</button>
                </div>
            </div>
            ...
            <div class="col-md-10  offset-2">
                ...
                <div class="card shadow-md mt-3 {{ $post->user->gender === 'Female' ? 'f1' : 'm1' }}"  style="width: 900px">
                    ...
                    <div class="card-body bg-secondary opacity-75 text-center">
        ...
        @if($posts->isEmpty())
            <div style="color: rgb(255, 0, 0)">
                <h1 class="text-center mt-4" style="font-size: 30px;">No post</h1>
            </div>
        @endif
